...
<table class="simple-little-table" cellspacing='0'  id="phoneTable" border="1" cellspacing="2" cellpadding="10" align="rigth">
    ...
    <c:forEach items="${phoneList}" var="phone" >
        <tr>
            ...
            <td>${phone.number}<input type="hidden" name="numbers" value="${phone.number}"></td>
            <td>${phone.description}<input type="hidden" name="descriptions" value="${phone.description}"></td>
            <td>${phone.comment}<input type="hidden" name="comments" value="${phone.comment}"></td>
        </tr>
    </c:forEach>
</table>
<script>
